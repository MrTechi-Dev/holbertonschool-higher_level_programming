...
class Rectangle(Base):
    ...
    def width(self):
        ...
        Return:
        the Recatangle width
        """
        return self.__width

    @property
    def height(self):
        """Height geter definition
        Return:
        the Recatangle height
        """
        return self.__height

    @property
    def x(self):
        """ x getter definitation"""
        return self.__x

    @property
    def y(self):
        """ y getter definitation"""
        return self.__y
    ...
    def display(self):
        """print # for the valu input stdout"""
    ...
    def to_dictionary(self):
        ...
        return {"id": self.id, "width": self.__width,
                "height": self.__height, "x": self.x, "y": self.y}
